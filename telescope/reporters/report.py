...
from telescope.reporters import AirflowReport, InfrastructureReport
...
def assemble(input_report: dict, output_filepath: str, report_type: str):
    output_reports = {"Summary Report": None, "Infrastructure Report": None, "Airflow Report": None, "DAG Report": None}
