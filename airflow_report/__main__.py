...
def usage_stats_report(session):
    ...
    sql = text(
        ...
        SELECT
            ...
            (SELECT PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY duration) FROM task_instance AS sti  WHERE state = 'success' AND start_date > {} AND sti.dag_id = ti.dag_id AND sti.operator != 'EmptyOperator' AND sti.operator != 'DummyOperator') AS "med_duration_1_days_success",
            ...
            (SELECT PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY duration) FROM task_instance AS sti  WHERE state = 'success' AND start_date > {} AND sti.dag_id = ti.dag_id AND sti.operator != 'EmptyOperator' AND sti.operator != 'DummyOperator') AS "med_duration_7_days_success",
            ...
            (SELECT PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY duration) FROM task_instance AS sti  WHERE state = 'success' AND start_date > {} AND sti.dag_id = ti.dag_id AND sti.operator != 'EmptyOperator' AND sti.operator != 'DummyOperator') AS "med_duration_30_days_success",
            ...
            (SELECT PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY duration) FROM task_instance AS sti  WHERE state = 'success' AND start_date > {} AND sti.dag_id = ti.dag_id AND sti.operator != 'EmptyOperator' AND sti.operator != 'DummyOperator') AS "med_duration_365_days_success",
            ...
            (SELECT PERCENTILE_CONT(0.5) WITHIN GROUP (ORDER BY duration) FROM task_instance AS sti  WHERE state = 'success' AND sti.dag_id = ti.dag_id AND sti.operator != 'EmptyOperator' AND sti.operator != 'DummyOperator') AS "med_duration_all_days_success"
